...
void GLState::paintGL() {
	...
	//glm::mat4 lightProjection = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, 0.0f, 20.0f);
	glm::mat4 lightProjection = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, 0.1f, 10.0f);
	// Calculate the light view matrix
	glm::vec3 lightDir = lights[0].getPos();
	glm::mat4 lightView = glm::lookAt(lightDir, glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0f, 1.0f, 0.0f));

	// Multiply the light projection and view matrices to obtain the lightSpaceMat matrix
